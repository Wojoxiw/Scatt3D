...
if __name__ == '__main__':
    ...
    # testPatchPattern(h=1/1.0, degree=3, freqs = np.linspace(8e9, 12e9, 50), name=runName, showPlots=False)
    # testPatchPattern(h=1/1.0, degree=3, name=runName, showPlots=True)
