...
#SBATCH -t 12:55:00 ## job is killed after this time - overestimate
...
#SBATCH --tasks-per-node=36 ##number of cores used per task? - up to 48 per node for COSMOS. Presumably this is what I want, using MPI
...
#SBATCH -J clarabe ##puts a job name, to identify it
