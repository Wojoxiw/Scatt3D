...
class MeshInfo():
    ...
    def createMesh(self, viewGMSH):
        ...
        self.meshData = dolfinx.io.gmsh.model_to_mesh(gmsh.model, self.comm, self.model_rank, self.tdim)#, dolfinx.mesh.create_cell_partitioner(dolfinx.cpp.mesh.GhostMode.shared_facet)) # don't need the partitioner anymore?
